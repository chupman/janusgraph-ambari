...
Ambari Agent
  ...
  https://github.com/apache/ambari/blob/branch-2.6/ambari-server/src/main/resources/common-services/TITAN/1.0.0/scripts/params.py
"""
...
janusgraph_solr_configset = 'janusgraph-configset'
janusgraph_solr_collection_name = 'default'
